...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseNpgsql("Host=localhost;Port=5432;Database=EducationalPractice;Username=postgres;Password=ahrur1234");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Academic>(entity =>
        {
            ...
            entity.Property(e => e.YearAccumulation).HasColumnName("year_accumulation");
        });
        ...
        {
            entity.HasKey(e => e.IdClassroom).HasName("classroom_pkey");

            entity.ToTable("classroom");

            entity.Property(e => e.IdClassroom).HasColumnName("Id_Classroom");
            entity.Property(e => e.ClassRoom).HasMaxLength(4);
        });
        ...
        modelBuilder.Entity<Exam>(entity =>
        {
            ...
            entity.HasOne(d => d.IdClassroomNavigation).WithMany(p => p.Exams)
                .HasForeignKey(d => d.IdClassroom)
                .HasConstraintName("exam_Id_Classroom_fkey");
        ...
        modelBuilder.Entity<Login>(entity =>
        {
            ...
            entity.HasOne(d => d.TabNumEmployeeNavigation).WithMany(p => p.Logins)
                ...
                .HasConstraintName("login_tab_num_employee_fkey");
        });
